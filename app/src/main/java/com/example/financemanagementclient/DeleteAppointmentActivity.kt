...
import com.example.financemanagementclient.databinding.ActivityDeleteAppointmentBinding
import com.google.firebase.database.DatabaseReference
import com.google.firebase.database.FirebaseDatabase

class DeleteAppointmentActivity : AppCompatActivity() {

    private lateinit var binding: ActivityDeleteAppointmentBinding
    private lateinit var databaseReference: DatabaseReference

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDeleteAppointmentBinding.inflate(layoutInflater)
